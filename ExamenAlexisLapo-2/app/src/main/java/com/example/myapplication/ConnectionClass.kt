...
class ConnectionClass(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        const val COL_AVION_LATITUD = "latitud"
        const val COL_AVION_LONGITUD = "longitud"
        const val COL_AVION_UBICACION = "ubicacion"
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        // Modificar la tabla Avion para incluir los nuevos campos
        db.execSQL("""      
            CREATE TABLE $TABLE_AVION (      
                ...
                $COL_AVION_LATITUD REAL NOT NULL,
                $COL_AVION_LONGITUD REAL NOT NULL,
                $COL_AVION_UBICACION TEXT NOT NULL
            )      
        """.trimIndent())
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        ...
        if (oldVersion < 2) {
            ...
            db.execSQL("ALTER TABLE $TABLE_AVION ADD COLUMN $COL_AVION_LATITUD REAL NOT NULL DEFAULT 0.0")
            db.execSQL("ALTER TABLE $TABLE_AVION ADD COLUMN $COL_AVION_LONGITUD REAL NOT NULL DEFAULT 0.0")
            db.execSQL("ALTER TABLE $TABLE_AVION ADD COLUMN $COL_AVION_UBICACION TEXT NOT NULL DEFAULT ''")
        }
    }
}